                   ...
                   showHUD:(BOOL)showHUD
{
    for (NSString *key in [params allKeys]) {
        if ([key isEqualToString:@"userId"]) {
            if ([HDToolHelper StringIsNullOrEmpty:params[key]]) {
...
//    manager.requestSerializer = [AFJSONRequestSerializer serializer];
    ...
    [manager POST:url parameters:paramsDict headers:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
