...
- (void)showOriImage{
    ...
    [tempView sd_setImageWithURL:[self highQualityImageURLForIndex:self.currentImageIndex]];
...
- (void)imageViewLongPressed:(UILongPressGestureRecognizer *)gesture{
    if(gesture.state == UIGestureRecognizerStateBegan){
        ...
        MHActionSheet *actionSheet = [[MHActionSheet alloc] initSheetWithTitle:nil style:MHSheetStyleWeiChat itemTitles:@[@"保存图片"]];
...
//    if ([self hasHighQImage]) {
//        NSLog(@"%@",[self highQualityImageURLForIndex:self.currentImageIndex]);
