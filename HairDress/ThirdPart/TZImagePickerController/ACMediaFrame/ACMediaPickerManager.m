...
static NSString *const str_openCamera = @"相机";
...
//            [self.currentViewController presentViewController:alert animated:YES completion:nil];
            MHActionSheet *actionSheet = [[MHActionSheet alloc] initSheetWithTitle:nil style:MHSheetStyleWeiChat itemTitles:@[@"拍摄",@"从手机相册选择"]];
