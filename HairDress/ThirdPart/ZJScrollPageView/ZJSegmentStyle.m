...
- (instancetype)init {
    if(self = [super init]) {
        ...
        self.segViewBackColor = [UIColor whiteColor];
        self.contentViewBackColor = [UIColor whiteColor];
        ...
        self.titleSelectedFont = [UIFont systemFontOfSize:14.0];
