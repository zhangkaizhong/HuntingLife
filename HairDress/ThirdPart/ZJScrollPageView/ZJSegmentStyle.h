...
/** 标题是否可点击刷新 */
@property (assign, nonatomic, getter=isTitleCanReload) BOOL titleCanReload;
/** 滚动视图的背景颜色 */
@property (strong, nonatomic) UIColor *segViewBackColor;
/** 内容视图的背景颜色 */
@property (strong, nonatomic) UIColor *contentViewBackColor;
/** 标题选中状态的颜色 */
