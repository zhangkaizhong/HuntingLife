...
//    if (self.delegate && [self.delegate respondsToSelector:@selector(ZJScrollViewContentViewDidScrollToIndex:)]) {
//        [self.delegate ZJScrollViewContentViewDidScrollToIndex:_currentIndex];
//    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(ZJScrollViewContentViewDidScrollToIndex:)]) {
        [self.delegate ZJScrollViewContentViewDidScrollToIndex:currentIndex];
    }
}
