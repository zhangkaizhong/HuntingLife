...
-(void)_createView
{
    ...
    UILabel *lblText = [[UILabel alloc] initCommonWithFrame:CGRectMake(0, 0, 150, navigationViewHeight) title:@"选择银行" bgColor:[UIColor clearColor] titleColor:RGBTEXT titleFont:17 textAlignment:NSTextAlignmentCenter isFit:NO];
...
-(UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    lable.text=[self.dataArray objectAtIndex:row][@"bankType"];
    //设置分割线的颜色
