...
- (id)upWeiChatStyeWithItems:(NSArray *)itemTitles title:(NSString *)title selfView:(MHActionSheet *)selfView
{
    ...
    selfView.marginView.backgroundColor = [UIColor colorWithRed:249/255.0 green:249/255.0 blue:249/255.0 alpha:1.0];
    selfView.marginView.alpha = 0.0;
    UIView *linetop = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kWW, 1)];
    linetop.backgroundColor = [UIColor colorWithRed:241/255.0 green:241/255.0 blue:241/255.0 alpha:1.0];
    [selfView.marginView addSubview:linetop];
    
    UIView *lineBottom = [[UIView alloc] initWithFrame:CGRectMake(0, kMargin-1, kWW, 1)];
    lineBottom.backgroundColor = [UIColor colorWithRed:241/255.0 green:241/255.0 blue:241/255.0 alpha:1.0];
    [selfView.marginView addSubview:lineBottom];
