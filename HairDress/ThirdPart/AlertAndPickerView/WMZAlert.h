...
typedef enum : NSUInteger{
    ...
    AlertTypeNornal,               //默认弹窗（删除店员弹窗）
    AlertTypeSelect,               //设置店员角色的弹窗 (有用的)
    AlertTypeQueueCheck,           //查看排队进度的弹窗 (有用的)
    AlertTypeTopay,                //支付弹窗 (有用的)
    AlertTypeYuyue,                //理发已预约的弹窗（有用的）
    AlertTypeAcceptTask,            //领取任务的弹窗（有用的）
    AlertTypeShareWeixin,            //去朋友圈分享（有用的）
    AlertTypeTaoBao             //淘宝授权提示
}AlertType;
