...
@interface HDNewServiceEvaluateViewController ()<UITableViewDelegate,UITableViewDataSource,navViewDelegate>
...
@implementation HDNewServiceEvaluateViewController
...
#pragma mark ================== 创建UI =====================
- (void)initUI{
    HDBaseNavView *navView = [[HDBaseNavView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_WIDTH, NAVHIGHT) title:@"服务评价" bgColor:[UIColor whiteColor] backBtn:YES rightBtn:@"" rightBtnImage:@"" theDelegate:self];
    [self.view addSubview:navView];
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NAVHIGHT, kSCREEN_WIDTH, kSCREEN_HEIGHT-NAVHIGHT) style:UITableViewStyleGrouped];
