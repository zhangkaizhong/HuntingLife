...
@interface HDTaoMallSubIconGoodsViewController () <navViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,HQTopStopViewDelegate>
...
@implementation HDTaoMallSubIconGoodsViewController
...
-(void)getGoodsListRequest:(BOOL)more{
    ...
    [MHNetworkManager postReqeustWithURL:URL_TaoIconGoodsList params:params successBlock:^(NSDictionary *returnData) {
...
- (UICollectionView *)mainCollectionView{
    if (!_mainCollectionView) {
        ...
        _mainCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0 , NAVHIGHT+1, kSCREEN_WIDTH, kSCREEN_HEIGHT-NAVHIGHT-1) collectionViewLayout:flowlayout];
